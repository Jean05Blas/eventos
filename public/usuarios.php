...
<body>
            ...
            <tbody>
                ...
                <td>
                        <div class="btn-group action-buttons">
                            <button href="#datosEmployeeModl" class="btn btn-success btn-sm"  data-toggle="modal">Datos</button>
                        </div>
                    </td>
              ...
              <td>1074 Binzhou Manor</td>
                ...
                <td>
                        <div class="btn-group action-buttons">
                            <button href="#datosEmployeeModl" class="btn btn- btn-sm"  data-toggle="modal">Datos</button>
                        </div>
                    </td>
   ...
   <!-- datos Modal HTML -->
   <div id="datosEmployeeModl" class="modal fade">
    <div class="modal-dialog modal-lg"> <!-- Cambiado a modal-lg para ancho mayor -->
        <div class="modal-content">
            <form>
                <div class="modal-header">            
                    <h4 class="modal-title">Agregar datos de usuario</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                <div class="modal-body">          
                    <div class="form-row">
